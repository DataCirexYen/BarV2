...
import {TokenChwomper} from "../src/TokenChwomper.sol";
...
contract RevenueBridgerFlowTest is Test {
    ...
    function testDeploymentFlow() public {
        ...
        RevenueBridger revenueBridger =
            new RevenueBridger(IMPERSONATED, address(tokenChwomper), MAINNET_RECIPIENT, BASE_USDC, LIFI_DIAMOND);
        ...
        assertEq(revenueBridger.mainnetRecipient(), MAINNET_RECIPIENT);
